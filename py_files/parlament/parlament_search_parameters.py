...
class parlament_search_keys():
    ...
    def get_parlament_session_ids(self,p_kade_id):
    ...
    def get_session_meeting_ids(self,p_kade_id,p_ses_id):
    ...
    def get_session_meeting_question_ids(self,p_kade_id,p_ses_id,p_fakt_pos_id):
